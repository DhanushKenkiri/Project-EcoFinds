      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="border-t pt-6 mt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-500 text-sm">© 2025 EcoFinds. All rights reserved.</p>
            <div className="flex space-x-4 mt-4 md:mt-0">
              <Link to="/terms" className="text-gray-500 text-sm hover:text-eco">Terms of Service</Link>
              <Link to="/privacy" className="text-gray-500 text-sm hover:text-eco">Privacy Policy</Link>
              <Link to="/cookies" className="text-gray-500 text-sm hover:text-eco">Cookie Policy</Link>
            </div>
          </div>
          <div className="flex flex-wrap justify-center md:justify-end gap-2 mt-4">
            ...
            <div className="h-6">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="#F7931A" stroke="#F7931A" strokeWidth="0" strokeLinecap="round" strokeLinejoin="round">
            ...
            <div className="h-6">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#627EEA" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
